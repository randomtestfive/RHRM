function lminigame()
  ...
  for i = 0, 3 do
    ...
    dancers[i].anim:addAnimation("right2",fw,fh*2,fw,fh,5, 50)
    dancers[i].anim:addAnimation("lets",0,fh*3,fw,fh,2,75)
    dancers[i].anim:addFrame("lets",fw*2,fh*3,fw,fh,100000)
    dancers[i].anim:addAnimation("sit",fw*3,fh*3,fw,fh,1,25)
